...
def main(args):
    ...
    encoder_model.load_state_dict(pretrained['model'])
...
def train(loader, model, criterion, optimizer, logger):
    ...
    for idx, (images, labels) in enumerate(loader):
        ...
        if idx % 50 == 0 or idx == len(loader)-1:
            ...
            #train_loss.append(loss_meter.mean)
            #train_miou.append(iou_meter.mean)
            #loss_meter.reset()
            #iou_meter.reset()
